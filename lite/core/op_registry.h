...
#define ParamTypeRegistry(                                                \
  ...
  static auto                                                             \
      op_type_metal__##target__##precision__##layout__##alias__##param_register \
...
#define REGISTER_LITE_OP(op_type__, OpClass)                                   \
  static paddle::lite_metal::OpLiteRegistrar op_type_metal__##__registry(                  \
      #op_type__, []() {                                                       \
        return std::unique_ptr<paddle::lite_metal::OpLite>(new OpClass(#op_type__)); \
      });                                                                      \
  int touch_op_metal_##op_type__() {                                                 \
    op_type_metal__##__registry.touch();                                             \
...
#define REGISTER_LITE_KERNEL(                                                 \
  ...
  static paddle::lite_metal::KernelRegistrar                                        \
      op_type_metal__##target__##precision__##layout__##alias__##_kernel_registry(  \
          #op_type__,                                                         \
          TARGET(target__),                                                   \
          PRECISION(precision__),                                             \
          DATALAYOUT(layout__),                                               \
