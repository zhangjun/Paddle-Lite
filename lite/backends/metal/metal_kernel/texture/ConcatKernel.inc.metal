...
#if V == VNORMAL
// kernel void FUNC(concat, R, N, normal, P)(array<texture2d_array<P,
// access::read>, N> in [[texture(0)]],
//                                     texture2d_array<P, access::read> out_x
//                                     [[texture(N)]],
//                                     texture2d_array<P, access::write> out
//                                     [[texture(N+1)]],
//                                     constant ConcatParam & pm [[buffer(0)]],
//                                     uint3 gid [[thread_position_in_grid]]) {
//}
kernel void FUNC(concat, R, N, VV, P)(
