...
#pragma mark - convAdd
kernel void conv_add_relu6_1x1(
...
kernel void conv_add_relu6_3x3(
    texture2d_array<float, access::sample> inTexture[[texture(0)]],
    texture2d_array<float, access::sample> biasTexture[[texture(1)]],
    texture2d_array<float, access::write> outTexture[[texture(2)]],
    constant MetalConvParam &param[[buffer(0)]],
...
kernel void conv_add_relu6_2x2(
    texture2d_array<float, access::sample> inTexture[[texture(0)]],
    texture2d_array<float, access::sample> biasTexture[[texture(1)]],
    texture2d_array<float, access::write> outTexture[[texture(2)]],
    constant MetalConvParam &param[[buffer(0)]],
...
kernel void group_conv_add_relu6_3x3(
    texture2d_array<float, access::sample> inTexture[[texture(0)]],
    texture2d_array<float, access::sample> biasTexture[[texture(1)]],
    texture2d_array<float, access::write> outTexture[[texture(2)]],
    constant MetalConvParam &param[[buffer(0)]],
...
kernel void conv_add_relu6_5x1(
    texture2d_array<float, access::sample> inTexture[[texture(0)]],
    texture2d_array<float, access::sample> biasTexture[[texture(1)]],
    texture2d_array<float, access::write> outTexture[[texture(2)]],
    constant MetalConvParam &param[[buffer(0)]],
...
kernel void conv_add_relu6_1x5(
    texture2d_array<float, access::sample> inTexture[[texture(0)]],
    texture2d_array<float, access::sample> biasTexture[[texture(1)]],
    texture2d_array<float, access::write> outTexture[[texture(2)]],
    constant MetalConvParam &param[[buffer(0)]],
...
kernel void conv_add_relu6_7x7(
    texture2d_array<float, access::sample> inTexture[[texture(0)]],
    texture2d_array<float, access::sample> biasTexture[[texture(1)]],
    texture2d_array<float, access::write> outTexture[[texture(2)]],
    constant MetalConvParam &param[[buffer(0)]],
...
kernel void depthwise_conv_add_relu6_3x3(
    texture2d_array<float, access::sample> inTexture[[texture(0)]],
    texture2d_array<float, access::sample> biasTexture[[texture(1)]],
    texture2d_array<float, access::write> outTexture[[texture(2)]],
    constant MetalConvParam &param[[buffer(0)]],
...
kernel void depthwise_conv_add_relu6_5x5(
    texture2d_array<float, access::sample> inTexture[[texture(0)]],
    texture2d_array<float, access::sample> biasTexture[[texture(1)]],
    texture2d_array<float, access::write> outTexture[[texture(2)]],
    constant MetalConvParam &param[[buffer(0)]],
...
kernel void conv_add_relu6_7x7_half(
...
kernel void conv_add_relu6_1x1_half(
    texture2d_array<half, access::sample> inTexture[[texture(0)]],
    texture2d_array<half, access::sample> biasTexture[[texture(1)]],
    texture2d_array<half, access::write> outTexture[[texture(2)]],
    constant MetalConvParam &param[[buffer(0)]],
  ...
  for (uint i = 0; i < input_arr_size; ++i) {
    input =
        float4(inTexture.sample(sample, float2(posInInput.x, posInInput.y), i));
    float4 weight_x =
        float4(weights[weithTo + 0 * kernelHXW * input_arr_size + i]);
    output.x += dot(input, weight_x);

    float4 weight_y =
        float4(weights[weithTo + 1 * kernelHXW * input_arr_size + i]);
    output.y += dot(input, weight_y);

    float4 weight_z =
        float4(weights[weithTo + 2 * kernelHXW * input_arr_size + i]);
    output.z += dot(input, weight_z);

    float4 weight_w =
        float4(weights[weithTo + 3 * kernelHXW * input_arr_size + i]);
    output.w += dot(input, weight_w);
  }
  float4 relu = param.hasReluOp ? fmin(fmax((float4)output, 0.0), 6.0) : output;
  outTexture.write(half4(relu), gid.xy, gid.z);
...
kernel void conv_add_relu6_1x1_quadruple_half(
    texture2d_array<half, access::sample> inTexture[[texture(0)]],
    texture2d_array<half, access::sample> biasTexture[[texture(1)]],
    texture2d_array<half, access::write> outTexture[[texture(2)]],
    constant MetalConvParam &param[[buffer(0)]],
  ...
  if (param.hasAddOp) {
    ...
    output3 =
        float4(getBiasHalf(uint3(tx + 1, ty + 1, tz), addParam, biasTexture));
  } else {
    output0 = float4(0);
    output1 = float4(0);
    output2 = float4(0);
...
kernel void conv_add_relu6_3x3_half(
    texture2d_array<half, access::sample> inTexture[[texture(0)]],
    texture2d_array<half, access::sample> biasTexture[[texture(1)]],
    texture2d_array<half, access::write> outTexture[[texture(2)]],
    constant MetalConvParam &param[[buffer(0)]],
...
kernel void conv_add_relu6_2x2_half(
    texture2d_array<half, access::sample> inTexture[[texture(0)]],
    texture2d_array<half, access::sample> biasTexture[[texture(1)]],
    texture2d_array<half, access::write> outTexture[[texture(2)]],
    constant MetalConvParam &param[[buffer(0)]],
...
kernel void conv_add_relu6_3x3_half_winograd(
    texture2d_array<half, access::sample> inTexture[[texture(0)]],
    texture2d_array<half, access::sample> biasTexture[[texture(1)]],
    texture2d_array<half, access::write> outTexture[[texture(2)]],
    constant MetalConvParam &param[[buffer(0)]],
  ...
  if (param.hasReluOp) {
    ...
    outTexture.write(
        fmin(fmax(output[3], 0.0), 6.0), uint2(tx + 1, ty + 1), tc);
  } else {
...
kernel void group_conv_add_relu6_3x3_half(
    texture2d_array<half, access::sample> inTexture[[texture(0)]],
    texture2d_array<half, access::sample> biasTexture[[texture(1)]],
    texture2d_array<half, access::write> outTexture[[texture(2)]],
    constant MetalConvParam &param[[buffer(0)]],
...
kernel void depthwise_conv_add_relu6_3x3_half(
    texture2d_array<half, access::sample> inTexture[[texture(0)]],
    texture2d_array<half, access::sample> biasTexture[[texture(1)]],
    texture2d_array<half, access::write> outTexture[[texture(2)]],
    constant MetalConvParam &param[[buffer(0)]],
...
kernel void depthwise_conv_add_relu6_3x3_half_winograd(
    texture2d_array<half, access::sample> inTexture[[texture(0)]],
    texture2d_array<half, access::sample> biasTexture[[texture(1)]],
    texture2d_array<half, access::write> outTexture[[texture(2)]],
    constant MetalConvParam &param[[buffer(0)]],
...
kernel void depthwise_conv_add_relu6_5x5_half(
    texture2d_array<half, access::sample> inTexture[[texture(0)]],
    texture2d_array<half, access::sample> biasTexture[[texture(1)]],
    texture2d_array<half, access::write> outTexture[[texture(2)]],
    constant MetalConvParam &param[[buffer(0)]],
    ...
    for (int j = 0; j < 5; j++) {
      half4 input =
          inTexture.sample(sample,
                           ...
                           output_slice);
      output.x +=
          float(input.x) * float(weights[weithTo + 0 * kernelHXW + 5 * i + j]);
      output.y +=
          float(input.y) * float(weights[weithTo + 1 * kernelHXW + 5 * i + j]);
      output.z +=
          float(input.z) * float(weights[weithTo + 2 * kernelHXW + 5 * i + j]);
      output.w +=
          float(input.w) * float(weights[weithTo + 3 * kernelHXW + 5 * i + j]);
    }
  }
  float4 relu = param.hasReluOp ? fmin(fmax((float4)output, 0.0), 6.0) : output;
  outTexture.write(half4(relu), gid.xy, gid.z);
...
kernel void conv_add_relu6_5x1_half(
    texture2d_array<half, access::sample> inTexture[[texture(0)]],
    texture2d_array<half, access::sample> biasTexture[[texture(1)]],
    texture2d_array<half, access::write> outTexture[[texture(2)]],
    constant MetalConvParam &param[[buffer(0)]],
...
kernel void conv_add_relu6_1x5_half(
    texture2d_array<half, access::sample> inTexture[[texture(0)]],
    texture2d_array<half, access::sample> biasTexture[[texture(1)]],
    texture2d_array<half, access::write> outTexture[[texture(2)]],
    constant MetalConvParam &param[[buffer(0)]],
