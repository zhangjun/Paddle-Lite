...
template class paddle::lite::kernels::metal::ReluImageCompute<float,
                                                              PRECISION(
                                                                  kFloat)>;
...
template class paddle::lite::kernels::metal::Relu6ImageCompute<float,
                                                               PRECISION(
                                                                   kFloat)>;
template class paddle::lite::kernels::metal::Relu6ImageCompute<MetalHalf,
                                                               PRECISION(
                                                                   kFP16)>;
