...
void Conv2dTransposeImageCompute<P, PTYPE>::PrepareForRun() {
  ...
  if (activate_type_ == 2) {
    ...
    if (index != -1)
      function_name_.replace(index, 4, "relu6");
  }
...
typedef paddle::lite::kernels::metal::Conv2dTransposeImageCompute<float,
                                                                  PRECISION(
                                                                      kFloat)>
    MetalConv2dTransposeFp32;
typedef paddle::lite::kernels::metal::Conv2dTransposeImageCompute<MetalHalf,
                                                                  PRECISION(
                                                                      kFP16)>
